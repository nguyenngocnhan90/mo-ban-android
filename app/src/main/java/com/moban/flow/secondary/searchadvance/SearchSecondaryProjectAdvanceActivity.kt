...
class SearchSecondaryProjectAdvanceActivity : BaseMvpActivity<ISearchSecondaryProjectAdvanceView, ISearchSecondaryProjectAdvancePresenter>(),
        ISearchSecondaryProjectAdvanceView {
    override var presenter: ISearchSecondaryProjectAdvancePresenter = SearchSecondaryProjectAdvancePresenterIml()
    ...
    companion object {
        fun start(context: Context) {
            val intent = Intent(context, SearchSecondaryProjectAdvanceActivity::class.java)
    ...
    override fun initialize(savedInstanceState: Bundle?) {
        ...
        search_advance_btn_search.setOnClickListener {
            ...
            SearchProjectResultActivity.startAdvance(this@SearchSecondaryProjectAdvanceActivity, param)
        }
        ...
        search_advance_tv_city.setOnClickListener {
            ...
            districtAdapter.listener = object : DistrictItemHandler {
                override fun onClicked(district: District) {
                    ...
                    val colorDark = Util.getColor(this@SearchSecondaryProjectAdvanceActivity, R.color.color_black)
