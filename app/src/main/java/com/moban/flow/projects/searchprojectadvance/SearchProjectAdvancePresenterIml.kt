 ...
 */
class SearchProjectAdvancePresenterIml: BaseMvpPresenter<ISearchProjectAdvanceView>, ISearchProjectAdvancePresenter {
    ...
    private var view: ISearchProjectAdvanceView? = null
    private var context: Context? = null

    override fun attachView(view: ISearchProjectAdvanceView) {
        this.view = view
