...
class ImageViewerView extends RelativeLayout
        implements OnDismissListener, SwipeToDismissListener.OnViewMoveListener, OnTouchImageListener, OnLongTouchImageListener {
    ...
    private OnLongTouchImageListener longTouchImageListener;
    private OnTouchImageListener touchImageListener;
    ...
    private void init() {
        inflate(getContext(), R.layout.item_image_viewer, this);
        ...
        gestureDetector = new GestureDetectorCompat(getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                if (pager.isScrolled()) {
                    ...
                    if (touchImageListener != null) {
                        touchImageListener.onTouchImage();
                    }
                }
                return false;
            }
            ...
            public void onLongPress(MotionEvent e) {
                super.onLongPress(e);
                if (longTouchImageListener != null) {
                    longTouchImageListener.onLongTouchImage();
                }
            }
        });
    }
    ...
    public void setOnTouchImageListener(OnTouchImageListener onTouchImageListener) {
        this.touchImageListener = onTouchImageListener;
    }

    public void setOnLongTouchImageListener(OnLongTouchImageListener onLongTouchImageListener) {
        this.longTouchImageListener = onLongTouchImageListener;
    }
