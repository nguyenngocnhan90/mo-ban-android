...
class ImageViewerAdapter
    ...
    private HashSet<ImageViewerAdapter.ImageViewHolder> holders;
    ...
    @Override
    public ImageViewerAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ZoomableDraweeView drawee = new ZoomableDraweeView(context);
        drawee.setEnabled(isZoomingAllowed);

        ImageViewerAdapter.ImageViewHolder holder = new ImageViewerAdapter.ImageViewHolder(drawee);
        holders.add(holder);
    ...
    @Override
    public void onBindViewHolder(ImageViewerAdapter.ImageViewHolder holder, int position) {
    ...
    boolean isScaled(int index) {
        for (ImageViewerAdapter.ImageViewHolder holder : holders) {
