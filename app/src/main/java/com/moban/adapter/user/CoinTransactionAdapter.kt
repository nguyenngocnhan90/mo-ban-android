...
class CoinTransactionAdapter:  RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    companion object {
    ...
    fun setTransactions(transactions: List<LhcTransaction>, isLoadMoreAvailable: Boolean) {
    ...
    fun appendTransactions(transactions: List<LhcTransaction>, isLoadMoreAvailable: Boolean) {
        this.isLoadMoreAvailable = isLoadMoreAvailable
    ...
    fun reloadTransactions(transaction: LhcTransaction) {
